# -*- coding: utf-8 -*-
# Generated by Django 1.11.1 on 2017-06-13 09:07
from __future__ import unicode_literals

from django.db import migrations, models
import django.db.models.deletion
import unichat.models.managers
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            managers=[
                ('objects', unichat.models.managers.UserManager()),
            ],
        ),
        migrations.CreateModel(
            name='City',
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(related_name='user_interested_schools', to='unichat.School'),
        ),
        migrations.AddField(
            model_name='user',
            name='school',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='unichat.School'),
        ),
        migrations.AddField(
            model_name='user',
