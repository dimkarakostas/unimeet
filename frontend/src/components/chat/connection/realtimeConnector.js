...
function realtimeConnector(token, realtimeUrl, handleNewMessageCallback, handleNextCallback, disableChatCallback) {
    ...
    this.joinRoom = function(roomId) {
        this._socket.emit('client-join-room', roomId, token);
    }
