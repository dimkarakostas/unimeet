...
function presenceConnector(token, presenceUrl, joinRoomCallback, alreadyConnectedCallback, queueUpdatePositionCallback) {
    ...
    this._socket.on('queue-position', (queuePosition) => {
        queueUpdatePositionCallback(queuePosition);
    });
